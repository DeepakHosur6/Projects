...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-dark">
		<div class="container-fluid">
			...
			<div>
				<a href="index.jsp">home</a><br> <a href="SignUp.jsp"
					class="btn btn-outline-success">SignUp</a><br> <a
					href="SignIn.jsp" class="btn btn-outline-success">SignIn</a><br>
				<a href="resetPassword.jsp">resetPassword</a><br> <a
					href="updatePassword.jsp">updatePassword</a><br>
			...
			<table>
				...
				<tr>
					...
					<td><input type="number" name="mobile" id="userMobile"
						onchange="validateMobile()" value="${dto.mobile}"> <span
	...
	<script>
		...
		function ValidateName() {
			...
			if (uservalue != null && uservalue != "" && uservalue.length > 3
				...
				console.log(uservalue);
				xhttp.open("GET",
						"http://localhost:8888/xworkz-sushma-cm/userName/"
								+ uservalue);
				xhttp.send();
